...
namespace UltimateTeam.Toolkit.Tests
{
    ...
    public class FutClientTests
    {
        ...
        public void GetWatchlistAsync_WhenResponseContainsValidData_ShouldNotThrow()
        {
            ...
            const string json = "{\"total\":1,\"auctionInfo\":[{\"tradeId\":137231545142,\"buyNowPrice\":0,\"tradeState\":\"closed\",\"offers\":0,\"itemData\":{\"id\":105863739699,\"timestamp\":1382222679,\"itemType\":\"player\",\"teamid\":11,\"rating\":78,\"lastSalePrice\":1000,\"owners\":2,\"morale\":50,\"formation\":\"f4321\",\"training\":0,\"untradeable\":false,\"preferredPosition\":\"ST\",\"assetId\":186146,\"itemState\":\"free\",\"resourceId\":1610798882,\"cardsubtypeid\":3,\"discardValue\":624,\"injuryType\":\"none\",\"injuryGames\":0,\"suspension\":0,\"fitness\":99,\"assists\":0,\"attributeList\":[{\"value\":85,\"index\":0},{\"value\":74,\"index\":1},{\"value\":73,\"index\":2},{\"value\":78,\"index\":3},{\"value\":45,\"index\":4},{\"value\":79,\"index\":5}],\"statsList\":[{\"value\":0,\"index\":0},{\"value\":0,\"index\":1},{\"value\":0,\"index\":2},{\"value\":0,\"index\":3},{\"value\":0,\"index\":4}],\"lifetimeStats\":[{\"value\":0,\"index\":0},{\"value\":0,\"index\":1},{\"value\":0,\"index\":2},{\"value\":0,\"index\":3},{\"value\":0,\"index\":4}],\"contract\":7,\"rareflag\":1,\"playStyle\":250,\"lifetimeAssists\":0,\"loyaltyBonus\":0},\"watched\":true,\"bidState\":\"outbid\",\"startingBid\":150,\"currentBid\":1000,\"expires\":-1,\"sellerName\":\"dummy_value\",\"sellerEstablished\":1310861136,\"sellerId\":0}],\"credits\":12345,\"duplicateItemIdList\":[{\"itemId\":105863739699,\"duplicateItemId\":105383426807}]}";

            #endregion
            var mock = TestHelpers.CreateMockHttpClientReturningJson(HttpMethod.Get, json);
            _futClient.RequestFactories.WatchlistRequestFactory = () => new WatchlistRequest { HttpClient = mock.Object };
        ...
        public void GetCreditsAsync_WhenResponseContainsValidData_ShouldNotThrow()
        {
            ...
            #endregion
            var mock = TestHelpers.CreateMockHttpClientReturningJson(HttpMethod.Get, json);
            _futClient.RequestFactories.CreditsRequestFactory = () => new CreditsRequest { HttpClient = mock.Object };
        ...
        public void GetTradePileAsync_WhenResponseContainsValidData_ShouldNotThrow()
        {
            ...
            #endregion
            var mock = TestHelpers.CreateMockHttpClientReturningJson(HttpMethod.Get, json);
            _futClient.RequestFactories.TradePileRequestFactory = () => new TradePileRequest { HttpClient = mock.Object };
        ...
        {
            #region JSON
            const string json = "{\"itemData\":[{\"id\":104891626302,\"timestamp\":1379143263,\"itemType\":\"player\",\"teamid\":11,\"rating\":87,\"lastSalePrice\":15750,\"owners\":5,\"morale\":50,\"formation\":\"f352\",\"resourceId\":1610753337,\"untradeable\":false,\"injuryGames\":0,\"statsList\":[{\"value\":0,\"index\":0},{\"value\":0,\"index\":1},{\"value\":0,\"index\":2},{\"value\":0,\"index\":3},{\"value\":0,\"index\":4}],\"attributeList\":[{\"value\":53,\"index\":0},{\"value\":41,\"index\":1},{\"value\":58,\"index\":2},{\"value\":51,\"index\":3},{\"value\":86,\"index\":4},{\"value\":90,\"index\":5}],\"lifetimeStats\":[{\"value\":46,\"index\":0},{\"value\":3,\"index\":1},{\"value\":2,\"index\":2},{\"value\":0,\"index\":3},{\"value\":0,\"index\":4}],\"preferredPosition\":\"CB\",\"assetId\":140601,\"itemState\":\"free\",\"training\":0,\"discardValue\":696,\"cardsubtypeid\":1,\"injuryType\":\"none\",\"suspension\":0,\"fitness\":89,\"assists\":0,\"contract\":2,\"rareflag\":1,\"playStyle\":262,\"lifetimeAssists\":1,\"loyaltyBonus\":0}],\"duplicateItemIdList\":[{\"itemId\":106085451240,\"duplicateItemId\":105135793199}]}";
            #endregion
            var mock = TestHelpers.CreateMockHttpClientReturningJson(HttpMethod.Get, json);
            _futClient.RequestFactories.PurchasedItemsRequestFactory = () => new PurchasedItemsRequest { HttpClient = mock.Object };
        ...
        public void QuickSellItemAsync_WhenResponseContainsValidData_ShouldNotThrow()
        {
            ...
            #endregion
            var mock = TestHelpers.CreateMockHttpClientReturningJson(HttpMethod.Post, json);
            _futClient.RequestFactories.QuickSellRequestFactory = auctionDetails => new QuickSellRequest(0) { HttpClient = mock.Object };
        ...
        public void SendItemToTradePileAsync_WhenResponseContainsValidData_ShouldNotThrow()
        {
            ...
            #endregion
            var mock = TestHelpers.CreateMockHttpClientReturningJson(HttpMethod.Post, json);
            _futClient.RequestFactories.SendItemToTradePileRequestFactory = itemData => new SendItemToTradePileRequest(itemData) { HttpClient = mock.Object };
